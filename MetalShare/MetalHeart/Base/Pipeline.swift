...
//  MetalShare
//
//  Created by shaoqianming on 2021/7/9.
//
...
public class TargetContainer: Sequence {
    ...
    let dispatchQueue = DispatchQueue(label: "com.kira.targetContainerQueue",
                                      attributes: [])
